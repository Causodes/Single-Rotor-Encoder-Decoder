...
public class MainActivity extends ActionBarActivity implements TopSectionFragment.TopSectionListenerClick {
    ...
    public void createCode(String top, String bottom) {
        ...
        bottomFragment.encrypt(top,bottom);
    }

    @Override
    public void decryptCode(String top, String bottom) {
        BottomSectionFragment bottomFragment= (BottomSectionFragment) getSupportFragmentManager().findFragmentById(R.id.fragment2);
        bottomFragment.decrypt(top,bottom);
    }
